...
function generateRandomType() {
  const types = ['blocked', 'interleaved'];
...
for(let i = 0;i<prac_learn_left.length;i++){
  prac_directUp.push(PRACbList[i])
  incorrectArr = i
  wrongA = i
  while (i == incorrectArr) {
    incorrectArr = Math.floor(Math.random() * 4)
  } 
  while (i == wrongA || wrongA==incorrectArr) {
    wrongA = Math.floor(Math.random() * 4)
  } 
  threeIndex = Math.floor(Math.random() * 3)+1
  if (threeIndex == 1){
    prac_directLeft.push(PRACaList[i])
    prac_directCorrect.push(PRACaList[i])
    prac_directMid.push(PRACaList[incorrectArr])
    prac_directRight.push(PRACaList[wrongA])
  } else if (threeIndex == 2){
    prac_directRight.push(PRACaList[i])
    prac_directCorrect.push(PRACaList[i])
    prac_directLeft.push(PRACaList[incorrectArr])
    prac_directMid.push(PRACaList[wrongA])
  } else {
    prac_directMid.push(PRACaList[i])
    prac_directCorrect.push(PRACaList[i])
    prac_directRight.push(PRACaList[incorrectArr])
...
for(let i = 0;i<15;i++){
  ...
  threeIndex = Math.floor(Math.random() * 3)+1
  if (threeIndex == 1){
    directLeft.push(aList[i])
    directCorrect.push(aList[i])
    directMid.push(aList[incorrectArr])
    directRight.push(aList[wrongA])
  } else if (threeIndex == 2){
    directRight.push(aList[i])
    directCorrect.push(aList[i])
    directLeft.push(aList[incorrectArr])
    directMid.push(aList[wrongA])
  } else {
    directMid.push(aList[i])
    directCorrect.push(aList[i])
    directRight.push(aList[incorrectArr])
...
for (let i = 0;i<15;i++){
  ...
  while (i == wrongShortA || wrongShortA == incorrectShortArr) {
